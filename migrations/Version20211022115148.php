 ...
 */
final class Version20211022115148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__element AS SELECT id, type, adresse, coord_gps FROM element');
        $this->addSql('DROP TABLE element');
        $this->addSql('CREATE TABLE element (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, etablissement_repertorie_id INTEGER DEFAULT NULL, type VARCHAR(255) NOT NULL COLLATE BINARY, adresse VARCHAR(255) NOT NULL COLLATE BINARY, coord_gps VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_41405E39FA20172D FOREIGN KEY (etablissement_repertorie_id) REFERENCES etablissement_repertorie (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO element (id, type, adresse, coord_gps) SELECT id, type, adresse, coord_gps FROM __temp__element');
        $this->addSql('DROP TABLE __temp__element');
        $this->addSql('CREATE INDEX IDX_41405E39FA20172D ON element (etablissement_repertorie_id)');
        $this->addSql('DROP INDEX IDX_C4C9AE45B70485B3');
        $this->addSql('CREATE TEMPORARY TABLE __temp__element_autoroute AS SELECT id, calque_id, type, adresse, coord_gps FROM element_autoroute');
        ...
        $this->addSql('INSERT INTO element_autoroute (id, calque_id, type, adresse, coord_gps) SELECT id, calque_id, type, adresse, coord_gps FROM __temp__element_autoroute');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__etablissement_repertorie AS SELECT id, calque_id, type, nom, adresse, coord_gps, description, photo, lien FROM etablissement_repertorie');
        ...
        $this->addSql('INSERT INTO etablissement_repertorie (id, calque_id, type, nom, adresse, coord_gps, description, photo, lien) SELECT id, calque_id, type, nom, adresse, coord_gps, description, photo, lien FROM __temp__etablissement_repertorie');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_41405E39FA20172D');
        $this->addSql('CREATE TEMPORARY TABLE __temp__element AS SELECT id, type, adresse, coord_gps FROM element');
        $this->addSql('DROP TABLE element');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__element_autoroute AS SELECT id, calque_id, type, adresse, coord_gps FROM element_autoroute');
        $this->addSql('DROP TABLE element_autoroute');
        $this->addSql('CREATE TABLE element_autoroute (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, calque_id INTEGER DEFAULT NULL, type VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, coord_gps VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO element_autoroute (id, calque_id, type, adresse, coord_gps) SELECT id, calque_id, type, adresse, coord_gps FROM __temp__element_autoroute');
        $this->addSql('DROP TABLE __temp__element_autoroute');
        $this->addSql('CREATE INDEX IDX_C4C9AE45B70485B3 ON element_autoroute (calque_id)');
        $this->addSql('DROP INDEX IDX_B170F90CB70485B3');
        $this->addSql('CREATE TEMPORARY TABLE __temp__etablissement_repertorie AS SELECT id, calque_id, type, nom, adresse, coord_gps, description, photo, lien FROM etablissement_repertorie');
        $this->addSql('DROP TABLE etablissement_repertorie');
        $this->addSql('CREATE TABLE etablissement_repertorie (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, calque_id INTEGER DEFAULT NULL, type VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, coord_gps VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, photo VARCHAR(255) NOT NULL, lien VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO etablissement_repertorie (id, calque_id, type, nom, adresse, coord_gps, description, photo, lien) SELECT id, calque_id, type, nom, adresse, coord_gps, description, photo, lien FROM __temp__etablissement_repertorie');
        $this->addSql('DROP TABLE __temp__etablissement_repertorie');
        $this->addSql('CREATE INDEX IDX_B170F90CB70485B3 ON etablissement_repertorie (calque_id)');
        $this->addSql('DROP INDEX IDX_6C24F39BB70485B3');
